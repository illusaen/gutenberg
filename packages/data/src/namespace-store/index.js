...
export default function createNamespace( key, options, registry ) {
	...
	const selectorsWithState = {
		...mapValues( metadataSelectors, ( selector ) => ( ...args ) => {
			return selector(
	...
	const selectors = mapValues( selectorsWithResolvers, ( selector ) => {
	...
	// Atom selectors
	const atomSelectors = mapValues( selectorsWithResolvers, ( selector ) => {
